...
from RL.environment import greenhouseEnv, normalizeObs, normalizeState
...
class value_function_TR():
    def __init__(self, input_dim, hidden_dim, learning_rate, batch_size,hidden_layers = 2, reduced = False):
        ...
        self.scheduler = torch.optim.lr_scheduler.LinearLR(self.optimizer, start_factor=1.0, end_factor=0.0, total_iters=max_steps)
